...
// Nu s-au putut obține datele care ar fi trebuit trimise.exit('Complare formular registration !');
}
...
if (strlen($_POST['password']) > 20 || strlen($_POST['password']) < 5) {
	exit('Password must have minimum 5 characters!');
}
...
if ($stmt->num_rows > 0) {
// Username exista
echo 'Username exists, pick a different name!';
} else {
